...
import type { setOfficerActiveAction } from './actions';

type Props = {
  id: string;
  isActive: boolean;
  action: typeof setOfficerActiveAction;
};

export default function ToggleOfficerButton({ id, isActive, action }: Props) {
