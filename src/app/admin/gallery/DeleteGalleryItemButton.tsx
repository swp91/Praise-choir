  ...
  return (
    <>
      <button
        ...
        className="flex items-center justify-center w-7 h-7 border border-red-200 bg-red-50 text-red-700 transition hover:border-red-500 hover:bg-red-100 shadow-sm"
        title="사진 삭제"
      >
        <svg
